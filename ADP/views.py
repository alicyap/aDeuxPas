...
#
#     # Récupérer les types de restaurants distincts
#     restaurant_types = Resto.objects.values_list('type', flat=True).distinct()
#
#     # Vérifier si des filtres sont appliqués
#     line_id = request.GET.get('line')
#     restaurant_type = request.GET.get('type')
#     type_activite = request.GET.get('type', 'Restaurant')
#
#
#     # Filtrer les restaurants selon les critères sélectionnés
#     restos = Resto.objects.all()
#     if line_id:
#         restos = restos.filter(metro__id=line_id)
#     if restaurant_type:
#         restos = restos.filter(type=restaurant_type)
#
...
#                 'name': resto.nom,
#                 'type': resto.type,
#                 'opening_hours': f"{resto.heures_ouverture}" if resto.heures_ouverture else None,
#                 'website': resto.site_web if resto.site_web else None,
#             }
#             for resto in restos
#         ]
#     }
